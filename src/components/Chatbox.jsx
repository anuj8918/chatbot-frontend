        ...
        <div className="flex h-full flex-col">
                ...
                <div className="mx-auto flex max-w-3xl flex-col gap-5">
                    ...
                    {messages.map((message, index) => {
                        ...
                        return (
                            ...
                            >
                                <div
                                    className={`max-w-[85%] rounded-2xl px-4 py-3 text-sm leading-6 shadow-lg ${isUser
                    ...
                    {loading && (
                        <div className="flex justify-start">
                            <div className="max-w-[60%] rounded-[2rem] border border-white/10 bg-white/5 px-5 py-4 text-sm text-slate-200">
                                Thinking...
                            </div>
                        </div>
                    )}
            ...
            <div className="sticky bottom-0 bg-[#020202] pb-6 pt-4">
                <form
                    ...
                    className="mx-auto flex max-w-3xl items-center gap-3 rounded-3xl border border-white/10 bg-white/5 px-4 py-3 shadow-lg"
                >
